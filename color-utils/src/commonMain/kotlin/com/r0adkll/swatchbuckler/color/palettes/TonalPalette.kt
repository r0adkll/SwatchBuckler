 ...
 */
package com.r0adkll.swatchbuckler.color.palettes
...
private constructor(
  ...
  private class KeyColor(private val hue: Double, private val requestedChroma: Double) {
     ...
     *
     * @return Key color [com.r0adkll.swatchbuckler.color.hct.Hct]
     */
    fun create(): Hct {
    ...
    private fun maxChroma(tone: Int): Double {
      return chromaCache.getOrPut(tone) { Hct.from(hue,
        MAX_CHROMA_VALUE, tone.toDouble()).chroma }
    }
