 ...
 */
package com.r0adkll.swatchbuckler.color.dynamiccolor

import com.r0adkll.swatchbuckler.color.contrast.Contrast
import com.r0adkll.swatchbuckler.color.dislike.DislikeAnalyzer
import com.r0adkll.swatchbuckler.color.dynamiccolor.DynamicScheme.Platform
import com.r0adkll.swatchbuckler.color.dynamiccolor.ToneDeltaPair.DeltaConstraint
import com.r0adkll.swatchbuckler.color.dynamiccolor.ToneDeltaPair.TonePolarity
import com.r0adkll.swatchbuckler.color.hct.Hct
import com.r0adkll.swatchbuckler.color.palettes.TonalPalette
import com.r0adkll.swatchbuckler.color.temperature.TemperatureCache
import com.r0adkll.swatchbuckler.color.utils.MathUtils
import kotlin.math.abs
import kotlin.math.max
import kotlin.math.min

/** [com.r0adkll.swatchbuckler.color.dynamiccolor.ColorSpec] implementation for the 2021 spec. */
  ...
  override val surfaceBright: DynamicColor
    get() =
      DynamicColor(
        ...
        tone = { scheme ->
          if (scheme.isDark) {
            ContrastCurve(24.0, 24.0, 29.0, 34.0)
              .get(scheme.contrastLevel)
          } else {
            98.0
          }
  ...
  override val surfaceContainerLow: DynamicColor
    get() =
      DynamicColor(
        ...
        tone = { scheme ->
          if (scheme.isDark) {
            ContrastCurve(10.0, 10.0, 11.0, 12.0)
              .get(scheme.contrastLevel)
          } else {
  ...
  override val surfaceContainer: DynamicColor
    get() =
      DynamicColor(
        ...
        tone = { scheme ->
          if (scheme.isDark) {
            ContrastCurve(12.0, 12.0, 16.0, 20.0)
              .get(scheme.contrastLevel)
          } else {
  ...
  override val surfaceContainerHigh: DynamicColor
    get() =
      DynamicColor(
        ...
        tone = { scheme ->
          if (scheme.isDark) {
            ContrastCurve(17.0, 17.0, 21.0, 25.0)
              .get(scheme.contrastLevel)
          } else {
  ...
  override val surfaceContainerHighest: DynamicColor
    get() =
      DynamicColor(
        ...
        tone = { scheme ->
          if (scheme.isDark) {
            ContrastCurve(22.0, 22.0, 26.0, 30.0)
              .get(scheme.contrastLevel)
          } else {
